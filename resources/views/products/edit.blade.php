                            ...
                            <form action="{{ route('products.update', $product->id) }}" method="POST"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="video" id="video"
                                        placeholder="Optional video link" value="{{ old('video', $product->video) }}" />
                                    @error('video')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    @if ($product->front_view_image)
                                        <div class="image-preview mt-2" id="frontPreviewContainer">
                                            <img src="{{ asset($product->front_view_image) }}" alt=""
                                                id="frontPreview" width="100%" />
                                        </div>
                                    @else
                                        <div class="image-preview mt-2" id="frontPreviewContainer"
                                            style="display: none;">
                                ...
                                <div class="form-group">
                                    ...
                                    @if ($product->back_view_image)
                                        <div class="image-preview mt-2" id="backPreviewContainer">
                                            <img src="{{ asset($product->back_view_image) }}" alt=""
                                                id="backPreview" width="100%" />
                                        </div>
                                    @else
                                ...
                                <div class="form-group">
                                    ...
                                    @if ($product->side_view_image)
                                        <div class="image-preview mt-2" id="sidePreviewContainer">
                                            <img src="{{ asset($product->side_view_image) }}" alt=""
                                                id="sidePreview" width="100%" />
                                        </div>
                                    @else
