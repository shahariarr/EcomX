                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="stock_status" id="stock_status">
                                                        ...
                                                        <option value="Out of Stock"
                                                            {{ old('stock_status') == 'Out of Stock' ? 'selected' : '' }}>
                                                            Out of Stock
                                                        </option>
                                                        <option value="Pre-order"
                                                            {{ old('stock_status') == 'Pre-order' ? 'selected' : '' }}>
                                                            Pre-order</option>
                                                    </select>
                                                    @error('stock_status')
                                                        <div class="text-danger">{{ $message }}</div>
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="custom-file">
                                                        <input type="file" class="custom-file-input"
                                                            ...
                                                            accept="image/*">
                                                        <label class="custom-file-label" for="front_view_image">Choose
                                                            file</label>
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="custom-file">
                                                        <input type="file" class="custom-file-input"
                                                            name="back_view_image" id="back_view_image" accept="image/*">
                                                        <label class="custom-file-label" for="back_view_image">Choose
                                                            file</label>
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="custom-file">
                                                        <input type="file" class="custom-file-input"
                                                            name="side_view_image" id="side_view_image" accept="image/*">
                                                        <label class="custom-file-label" for="side_view_image">Choose
                                                            file</label>
                                                    </div>
